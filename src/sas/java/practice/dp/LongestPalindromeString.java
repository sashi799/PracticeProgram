...
public class LongestPalindromeString {
	...
	public static String LPS(String s) {
		  ...
		  for (int i = 0; i < n; i++) {
			  palindrome[i][i] = true;
			  System.out.println(s.substring(i, max_len + i));
		  }
		  ...
		  for (int i = 0; i < n-1; i++) {
		    if (s.charAt(i) == s.charAt(i+1)) {
		      ...
		      max_len = 2;
		      System.out.println(s.substring(palindromeBeginsAt, max_len + palindromeBeginsAt));
		    }
		  }
	...
	{
		System.out.println("Longest Palindrome = "+LPS("banana"));
	}
